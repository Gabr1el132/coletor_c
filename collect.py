...
from collectors.thehuxley import HuxleyCollector
...
def build_parser() -> argparse.ArgumentParser:
    ...
    # ── TheHuxley ──────────────────────────────────────────────────────────────
    hux = sub.add_parser("thehuxley", help="Coletar do TheHuxley (thehuxley.com)")
    hux.add_argument("--url", default="https://www.thehuxley.com", help="URL base (padrão: thehuxley.com)")
    hux.add_argument("--user", required=True, help="E-mail ou login do professor")
    hux.add_argument("--password", required=True)
    hux.add_argument("--group-id", help="ID de uma turma específica (omitir = todas as turmas do professor)")
